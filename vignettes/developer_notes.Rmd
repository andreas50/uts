...
This document describes some of the inner workings of the `uts` and `utsMultivariate` package and targets developers who want to extend the functionality. In addition, the document lays out coding and commenting guidelines for package contributors.
