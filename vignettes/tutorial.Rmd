...
Methods that operate in terms of observations typically have an integer argument, specifying the number of consecutive observations involved in the operation.

On the other hand, methods that operate in terms of time units typically have a duration object as an argument, specifying the width of a rolling time window. Observations falling into this time window or involved in the operation, and the number of such observations varies over time depending on the observation density.
