...
* [zoo](http://cran.r-project.org/web/packages/zoo/index.html):
  ...
  * Indexing into a time series is in terms of observation numbers (e.g. get observations at integer indices 5, 6, and 9), as opposed to in terms of observation times (get sampled observations at given time points).
